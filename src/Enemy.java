...
public class Enemy {
    ...
    public Enemy(int pXPos, int pYPos, int pWidth, int pHeight, SpriteSheet pSpriteSheet, Control pControl) {
        ...
        viewRadius = new Ellipse2D.Double(xPos-240-control.camera.getXOffset(), yPos-240-control.camera.getYOffset(), 480, 480);
        attackRadius = new Ellipse2D.Double(xPos-96-Control.camera.getXOffset(), yPos-96-Control.camera.getYOffset(), 192, 192);
    }
    ...
    public void setMove(Point pMove) {
        ...
        if (wallCheck() || (grounded && (!(control.map.getLayerList().get(0).tiles[(int) leftBottom.getX() / 64][(int) leftBottom.getY() / 64].isBlocked())) || (!(control.map.getLayerList().get(0).tiles[(int) rightBottom.getX() / 64][(int) rightBottom.getY() / 64].isBlocked())))){
            xPos=oldX;
            movement=-movement;
        }

        viewRadius.setFrame(xPos-240-control.camera.getXOffset(), yPos-240-control.camera.getYOffset(), 480, 480);
        attackRadius.setFrame(xPos-96-Control.camera.getXOffset(), yPos-96-Control.camera.getYOffset(), 192, 192);
    }
...
//        g2d.fill(attackRadius);
        ...
        g2d.fillRect(xPos-control.camera.getXOffset()+10, yPos - control.camera.getYOffset(), hp, 10);
        g2d.setColor(Color.red);
        g2d.fillRect(xPos-control.camera.getXOffset()+10+hp, yPos - control.camera.getYOffset(), 100-hp, 10);
    }
